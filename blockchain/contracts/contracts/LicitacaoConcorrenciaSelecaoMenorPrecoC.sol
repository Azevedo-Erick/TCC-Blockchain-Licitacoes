...
contract LicitacaoConcorrenciaSelecaoMenorPrecoC {
    ...
    event LicitacaoCriada(string titulo, string descricao, string hashETP, string hashEdital, uint256 dataInicio);
    event CandidaturaEnviada(address candidato, string hashCandidatura, uint256 timestamp);
    ...
    function criarLicitacao(
        ...
        string memory _hashETP,
        string memory  _hashEdital,
        uint256 _dataInicio,
    ...
    function enviarCandidatura(string memory _hashCandidatura) public apenasEmEstagio(Estagio.Candidatura) apenasDuranteCandidatura {
